* Description: Cuervo-Cazurra and Genc (2008) replication - model 2a (updated data version)
...
egen row_missing = rowmiss(prop_emne_excl_nat_res gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link)
...
log using "../results/model_2a_replication.log", replace text
xttobit prop_emne_excl_nat_res gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, ll(0) ul(100) re
...
tobit prop_emne_excl_nat_res gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, ll(0) ul(100)
