* Description: Cuervo-Cazurra and Genc (2008) replication - model 1a (updated data version)
...
egen row_missing = rowmiss(prop_emne gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link)
...
esttab re_model using "../results/model_1a_results.csv", replace title("Random Effects Panel Tobit Results") label se b(%9.4f) star(* 0.10 ** 0.05 *** 0.01)
