* Description: Greenfield panel analysis - model 6a
...
egen row_missing = rowmiss(prop_emne_capital_excl_nat_res gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link)
...
esttab re_model using "../results/model_6a_results.csv", replace title("Random Effects Panel Tobit Results") label se b(%9.4f) star(* 0.10 ** 0.05 *** 0.01)
...
asdoc pwcorr prop_emne_capital_excl_nat_res gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, save(../results/model_6a_correlation_matrix.doc) replace title(Correlation Matrix)
