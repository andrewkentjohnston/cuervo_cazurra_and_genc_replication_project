* Description: Greenfield panel analysis - model 7a
...
egen row_missing = rowmiss(prop_emne_capital_excl_col_link gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link)
...
xttobit prop_emne_capital_excl_col_link gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, ll(0) ul(1) re
...
tobit prop_emne_capital_excl_col_link gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, ll(0) ul(1)
...
asdoc pwcorr prop_emne_capital_excl_col_link gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link, save(../results/model_7a_correlation_matrix.doc) replace title(Correlation Matrix)
