* Description: Cuervo-Cazurra and Genc (2008) replication (updated data version)
...
log using "../results/model_1a_replication.log", append text
summarize prop_emne gni_per_capita broadband_per_capita mobiles_per_capita geographic_proximity colonial_link
